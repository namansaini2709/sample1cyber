...
# Define table creation and population functions to ensure data integrity
# Create tables
...
def setup_db():
    ...
    # Create orders table
    create_orders_table(c)
    conn.commit()
    
    # Populate users table
    populate_users_table(c)
    conn.commit()
    
    # Populate products table
    populate_products_table(c)
    conn.commit()
    
    # Populate orders table
    populate_orders_table(c)
    conn.commit()
    conn.close()
